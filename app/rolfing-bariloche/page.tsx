...
export const metadata: Metadata = {
  ...
  description:
    "Rolfing y trabajo corporal con Ferran Moreno para clientes en Bariloche y la Patagonia argentina. Sesiones online de profundidad real. Más de 20 años de experiencia. El trabajo va más allá del Rolfing — integra estructura, regulación del sistema nervioso, trabajo energético, mental y emocional.",
  alternates: { canonical: "/rolfing-bariloche" },
  keywords: [
    "rolfing Bariloche",
    "rolfing Patagonia",
    "rolfing Argentina",
    "trabajo corporal Bariloche",
    "trabajo corporal Patagonia",
    "integración estructural Bariloche",
    "regulación sistema nervioso Bariloche",
    "rolfing online Argentina",
    "Ferran Moreno Bariloche",
  ],
  openGraph: {
    title: "Rolfing en Bariloche | Ferran Moreno",
    description:
      "Trabajo corporal y Rolfing para clientes en Bariloche y la Patagonia. Sesiones online + intensivos en Barcelona.",
    url: `${siteUrl}/rolfing-bariloche`,
      ...
      <main>
        ...
        <section style={{ borderBottom: "1px solid rgba(124,58,237,0.3)", background: "#7C3AED", color: "#fff" }}>
          <div className="mx-auto max-w-[900px] px-6 py-[120px]">
            ...
            <div className="mt-12">
              <a
                href={`${contactWhatsApp}?text=Hola%20Ferran%2C%20estoy%20en%20Bariloche%20y%20me%20interesa%20trabajar%20contigo`}
                target="_blank"
        ...
        <section style={{ borderBottom: "1px solid var(--border-subtle)" }}>
          <div className="mx-auto max-w-[900px] px-6 py-[100px]">
            <div className="text-sm uppercase tracking-[0.25em]" style={{ color: "var(--text-secondary)" }}>Cómo funciona desde Bariloche</div>
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              <div className="rounded-[2rem] p-10" style={{ border: "1px solid var(--border-subtle)", background: "var(--bg-soft)" }}>
                ...
                <p className="leading-[1.8]">Trabajo regular por videollamada. Lectura estructural, regulación del sistema nervioso, guía de movimiento, trabajo energético y emocional. La distancia no reduce la profundidad.</p>
              ...
              <div className="rounded-[2rem] p-10" style={{ border: "1px solid var(--border-subtle)", background: "var(--bg-soft)" }}>
                ...
                <p className="leading-[1.8]">2-3 días de trabajo manual estructural en Lluçà. Para casos donde el siguiente nivel requiere contacto directo.</p>
        ...
        <section>
          <div className="mx-auto max-w-[900px] px-6 py-[120px] text-center">
            ...
            <p className="mt-5 text-sm" style={{ color: "var(--text-secondary)" }}>
              {contactWhatsAppDisplay} · Online desde Bariloche · Presencial en Barcelona
            </p>
          </div>
        </section>
