      ...
      <main>
        ...
        <section style={{ borderBottom: "1px solid var(--border-subtle)", background: "var(--bg-soft)" }}>
          <div className="mx-auto max-w-[900px] px-6 py-[100px]">
            <div className="text-sm uppercase tracking-[0.25em]" style={{ color: "var(--text-secondary)" }}>The work</div>
            <h2 className="mt-3 text-3xl font-medium tracking-tight">Rolfing is structural work. Not massage.</h2>
            <p className="mt-6 text-lg leading-[1.8]" style={{ color: "var(--text-secondary)" }}>
              Rolfing — or Structural Integration — works on how the body is organized in gravity. Not the symptom. The pattern. A shoulder that keeps seizing isn&apos;t a shoulder problem. It&apos;s a system that compensates. We work on the compensation, not just the output.
            </p>
            <div className="mt-12 grid gap-5 md:grid-cols-2">
              {[
                { title: "Structure", text: "Reading how your body is organized. Where the compensations are. Where the real origin is." },
                { title: "Regulation", text: "Returning range to the nervous system. The body can&apos;t reorganize when it&apos;s in constant threat response." },
                { title: "Energy", text: "Clearing interference. This layer works regardless of physical distance — consistently, across years of practice." },
                { title: "Integration", text: "Change that holds. Not temporary relief. Reorganization that carries into daily life." },
              ].map((item) => (
                <div key={item.title} className="rounded-[1.75rem] p-8" style={{ border: "1px solid var(--border-subtle)", background: "var(--bg-main)" }}>
                  ...
                  <p className="mt-3 leading-[1.8]" style={{ color: "var(--text-secondary)" }}
