...
const allArticles = [
  { slug: "bara-bala-you-cant-feel-without-believing", title: "Bara bala: you can&apos;t feel without believing", date: "2026-02-07", tag: "Process" },
  { slug: "the-barista-who-cried", title: "The barista who cried", date: "2026-01-30", tag: "Energy" },
  { slug: "the-mole-mental-mechanism", title: "The mole: the mental mechanism that blocks your body", date: "2026-02-19", tag: "Process" },
  { slug: "the-mental-cassette-tapes", title: "The mental cassette tapes", date: "2026-02-23", tag: "Process" },
  { slug: "the-shadow-makes-you-forget", title: "The shadow makes you forget you were ever well", date: "2026-02-15", tag: "Process" },
  { slug: "contraction-or-expansion", title: "Contraction or expansion", date: "2026-02-11", tag: "Process" },
  { slug: "the-people-with-the-sack", title: "The people with the sack", date: "2026-01-26", tag: "Process" },
  { slug: "hold-your-light", title: "Hold your light", date: "2026-01-22", tag: "High performance" },
  { slug: "the-bodys-handbrake", title: "The body&apos;s handbrake", date: "2026-03-08", tag: "Bodywork" },
  { slug: "manager-or-micromanager-of-your-life", title: "Manager or micromanager", date: "2026-02-03", tag: "Process" },
  { slug: "nothing-is-just-physical", title: "Nothing is just physical", date: "2026-03-12", tag: "Nervous system" },
  { slug: "you-dont-need-to-understand-you-need-to-be-well", title: "You don&apos;t need to understand. You need to be well", date: "2026-02-27", tag: "Process" },
  { slug: "everything-is-frequency", title: "Everything is frequency", date: "2026-03-20", tag: "Training" },
  { slug: "what-to-expect-first-session", title: "What to expect in your first session", date: "2026-04-25", tag: "First session" },
  { slug: "what-really-happens-in-a-session", title: "What really happens in a session", date: "2026-04-22", tag: "Session" },
  { slug: "bodywork-after-pregnancy", title: "Bodywork after pregnancy", date: "2026-04-15", tag: "Postpartum" },
  { slug: "rolfing-vs-physiotherapy-difference", title: "Rolfing vs physiotherapy", date: "2026-04-18", tag: "Rolfing" },
  { slug: "why-i-work-by-process-not-single-sessions", title: "Why I work by process", date: "2026-04-29", tag: "Process" },
  { slug: "what-your-hands-can-read", title: "What your hands can read", date: "2026-03-28", tag: "Bodywork" },
  { slug: "20-years-training-across-20-countries", title: "20 years training across 20 countries", date: "2026-03-24", tag: "Training" },
  { slug: "energy-work-isnt-what-you-think", title: "Energy work isn&apos;t what you think", date: "2026-03-16", tag: "Energy" },
  ...
  { slug: "what-defines-the-price-of-an-intervention", title: "What defines the price of an intervention", date: "2026-05-27", tag: "Process" },
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/en/blog",
    languages: { es: "/blog", en: "/en/blog", "x-default": "/en/blog" },
  },
  openGraph: {
      ...
      <main className="mx-auto max-w-[700px] px-6 py-24">
        ...
        <section className="mb-20">
          ...
          <h2 className="text-xl font-medium tracking-tight mb-3">
            If you don&apos;t know what to read first, enter through the door that feels closest to what&apos;s happening in you right now.
          </h2>
