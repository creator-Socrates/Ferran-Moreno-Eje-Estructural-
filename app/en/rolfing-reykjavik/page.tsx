  ...
  return (
    <>
      <LocationStructuredData
        ...
        country="IS"
        lang="en"
        slug="rolfing-reykjavik"
        description="Bodywork and structural work for clients in Reykjavik and Iceland. Online sessions with the same depth as in-person. In-person intensives in Barcelona. The work goes beyond Rolfing — structural, nervous system, energetic, mental and emotional layers."
      />
        ...
        <section style={{ borderBottom: "1px solid rgba(124,58,237,0.3)", background: "#7C3AED", color: "#fff" }}>
          <div className="mx-auto max-w-[900px] px-6 py-[120px]">
            ...
            <h1 className="text-5xl font-semibold leading-[1.15] tracking-tight lg:text-6xl">
              ROLFING
              <span className="block" style={{ color: "rgba(255,255,255,0.75)" }}>FOR CLIENTS IN REYKJAVIK</span>
            </h1>
            ...
            <div className="mt-12">
              <a href={`${contactWhatsApp}?text=Hi%20Ferran%2C%20I%27m%20in%20Reykjavik%20and%20interested%20in%20working%20with%20you`} target="_blank" rel="noopener noreferrer" className="rounded-full px-7 py-3.5 text-sm font-medium text-white transition hover:opacity-85" style={{ background: "#F97316" }}>Get in touch</a>
            </div>
          </div>
        </section>
