...
export const metadata: Metadata = {
  title: "Rolfing in Oslo | Online & Intensive Sessions",
  description:
    "Bodywork and structural work for clients in Oslo and Norway. Online sessions with the same depth as in-person. In-person intensives in Barcelona. The work goes beyond Rolfing — structural, nervous system, energetic, mental and emotional layers.",
  alternates: { canonical: "/en/rolfing-oslo" },
  keywords: [
    "rolfing oslo",
    "rolfing norway",
    "structural integration oslo",
    "bodywork oslo",
    "somatic work norway",
    "nervous system regulation norway",
    "online rolfing norway",
    "deep bodywork norway",
    "Ferran Moreno norway",
  ],
  openGraph: {
    title: "Rolfing in Oslo | Ferran Moreno",
    description:
      "Bodywork for clients in Oslo. Online sessions + intensive in Barcelona. Beyond Rolfing.",
    url: `${siteUrl}/en/rolfing-oslo`,
...
export default function RolfingOslo() {
  return (
    <>
      <LocationStructuredData
        ...
        lang="en"
        slug="rolfing-oslo"
        description="Bodywork and structural work for clients in Oslo and Norway. Online sessions with the same depth as in-person. In-person intensives in Barcelona. The work goes beyond Rolfing — structural, nervous system, energetic, mental and emotional layers."
      />
    <div className="min-h-screen" style={{ background: "var(--bg-main)", color: "var(--text-main)" }}>
      ...
      <main>
        ...
        <section style={{ borderBottom: "1px solid var(--border-subtle)" }}>
          <div className="mx-auto max-w-[900px] px-6 py-[100px]">
            <div className="text-sm uppercase tracking-[0.25em]" style={{ color: "var(--text-secondary)" }}>How it works from Oslo</div>
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2">
              ...
              <div className="rounded-[2rem] p-10" style={{ border: "1px solid var(--border-subtle)", background: "var(--bg-soft)" }}>
                ...
                <p className="leading-[1.8]">2–3 days of direct manual structural work in Lluçà, Barcelona. Oslo to Barcelona is a short flight. Used when the next layer requires direct contact.</p>
        ...
        <section>
          <div className="mx-auto max-w-[900px] px-6 py-[120px] text-center">
            ...
            <div className="mt-10">
              <a href={`${contactWhatsApp}?text=Hi%20Ferran%2C%20I%27m%20in%20Oslo%20and%20interested%20in%20your%20work`} target="_blank" rel="noopener noreferrer" className="rounded-full px-10 py-4 text-base font-medium text-white transition hover:opacity-85" style={{ background: "var(--text-main)" }}>Contact via WhatsApp</a>
            </div>
            <p className="mt-5 text-sm" style={{ color: "var(--text-secondary)" }}>{contactWhatsAppDisplay} · Online from Oslo · In-person in Barcelona</p>
          </div>
        </section>
      </main>
