...
const allArticles = [
  { slug: "bara-bala-no-puedes-sentir-sin-creer", title: "Bara bala: no puedes sentir sin creer", date: "2026-02-07", tag: "Proceso" },
  { slug: "la-barista-que-lloro", title: "La barista que lloró", date: "2026-01-30", tag: "Energía" },
  { slug: "el-topo-mecanismo-mental", title: "El topo: el mecanismo mental que bloquea tu cuerpo", date: "2026-02-19", tag: "Proceso" },
  { slug: "las-casetes-mentales", title: "Las casetes mentales que recrean tu sufrimiento", date: "2026-02-23", tag: "Proceso" },
  { slug: "la-sombra-te-hace-olvidar", title: "La sombra te hace olvidar que alguna vez estuviste bien", date: "2026-02-15", tag: "Proceso" },
  { slug: "contraccion-o-expansion", title: "Contracción o expansión: la única pregunta que necesitas", date: "2026-02-11", tag: "Proceso" },
  { slug: "las-personas-con-la-mochila", title: "Las personas con la mochila", date: "2026-01-26", tag: "Proceso" },
  { slug: "sostener-tu-luz", title: "Sostener tu luz", date: "2026-01-22", tag: "Alto rendimiento" },
  { slug: "el-freno-de-mano-del-cuerpo", title: "El freno de mano del cuerpo", date: "2026-03-08", tag: "Trabajo corporal" },
  { slug: "manager-o-micromanager-de-tu-vida", title: "Manager o micromanager de tu propia vida", date: "2026-02-03", tag: "Proceso" },
  { slug: "no-hay-nada-solo-fisico", title: "No hay nada solo físico", date: "2026-03-12", tag: "Sistema nervioso" },
  { slug: "no-necesitas-entender-necesitas-estar-bien", title: "No necesitas entender. Necesitas estar bien", date: "2026-02-27", tag: "Proceso" },
  { slug: "todo-es-frecuencia", title: "Todo es frecuencia", date: "2026-03-20", tag: "Formación" },
  { slug: "que-esperar-en-tu-primera-sesion", title: "Qué esperar en tu primera sesión", date: "2026-04-25", tag: "Primera sesión" },
  { slug: "que-pasa-en-una-sesion", title: "Qué pasa realmente en una sesión", date: "2026-04-22", tag: "Sesión" },
  { slug: "trabajo-corporal-despues-del-embarazo", title: "Trabajo corporal después del embarazo", date: "2026-04-15", tag: "Postparto" },
  { slug: "rolfing-vs-fisioterapia-diferencia", title: "Rolfing vs fisioterapia: cuál es la diferencia", date: "2026-04-18", tag: "Rolfing" },
  { slug: "por-que-trabajo-por-proceso", title: "Por qué trabajo por proceso", date: "2026-04-29", tag: "Proceso" },
  { slug: "lo-que-tus-manos-pueden-leer", title: "Lo que tus manos pueden leer", date: "2026-03-28", tag: "Trabajo corporal" },
  { slug: "20-anos-formandome-en-20-paises", title: "20 años formándome en 20 países", date: "2026-03-24", tag: "Formación" },
  { slug: "trabajo-energetico-no-es-lo-que-piensas", title: "El trabajo energético no es lo que piensas", date: "2026-03-16", tag: "Energía" },
            ...
            {[
              {
                ...
                text: "Cuando el síntoma mejora, pero el patrón sigue reapareciendo.",
                href: "/blog/el-dolor-rara-vez-empieza-donde-duele",
              },
              {
                title: "Sistema nervioso saturado",
                text: "Cuando el cuerpo funciona, pero vive en activación constante.",
                href: "/blog/la-ram-del-sistema-nervioso",
              },
              {
                title: "Alto rendimiento y presión",
                text: "Para cuerpos que sostienen decisiones, presencia, impacto o exigencia.",
                href: "/blog/ceos-y-sistema-nervioso",
              },
              {
                title: "Primera sesión y proceso",
                text: "Qué ocurre al empezar y por qué no trabajamos por sesiones sueltas.",
                href: "/blog/que-esperar-en-tu-primera-sesion",
              },
            ].map((door) => (
              <Link
                key={door.title}
