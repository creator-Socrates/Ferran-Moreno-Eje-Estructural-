...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/blog/el-alivio-no-es-expansion",
  },
};
...
Tensión otra vez.
            ...
            <p className="text-[15px] leading-relaxed">
              El alivio es la ausencia temporal del síntoma.
La expansión es otra cosa.
            </p>

            <p className="text-[15px] leading-relaxed">
              Expansión significa que el cuerpo ganó espacio.
Más respiración.
Más margen.
