...
Son estrategias.
            ...
            <p className="text-[15px] leading-relaxed">
              Una pelvis se rigidiza para proteger una lesión antigua.
El tórax se cierra después de años de estrés.
La respiración se vuelve superficial porque el cuerpo aprendió que relajarse no era seguro.
La mandíbula aprieta porque el sistema necesita mantenerse preparado.
            </p>
...
sensación constante de esfuerzo interno.
            ...
            <p className="text-[15px] leading-relaxed">
              Por eso el trabajo profundo no consiste en &ldquo;forzar al cuerpo a cambiar&rdquo;. Consiste en crear las condiciones para que deje de organizarse alrededor de la supervivencia constante.
            </p>
...
el cuerpo deja de prepararse para una amenaza invisible.
            ...
            <p className="text-[15px] leading-relaxed">
              Y muchas personas descubren algo sorprendente:
la cantidad de energía que estaban gastando simplemente intentando sostenerse.
            </p>
