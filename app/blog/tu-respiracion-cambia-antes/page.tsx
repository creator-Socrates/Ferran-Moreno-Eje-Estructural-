      ...
      <main className="mx-auto max-w-[700px] px-6 py-24">
        ...
        <article>
          ...
          <div className="space-y-6">
            ...
            <p className="text-[15px] leading-relaxed">
              Cuando hay amenaza, se acorta.<br />
              Cuando hay seguridad, se profundiza.<br />
              Cuando hay defensa, sube al pecho.<br />
            ...
            <p className="text-[15px] leading-relaxed">
              Antes de que la persona lo note.<br />
              Antes de que lo entienda.<br />
          ...
          <RelatedArticles slug="tu-respiracion-cambia-antes" lang="es" />
        </article>
      </main>
    </div>
  );
