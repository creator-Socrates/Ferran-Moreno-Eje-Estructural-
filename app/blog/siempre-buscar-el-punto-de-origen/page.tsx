...
export const metadata: Metadata = {
  ...
  alternates: getBlogAlternates("es", "siempre-buscar-el-punto-de-origen"),
};
      ...
      <main className="mx-auto max-w-[700px] px-6 py-24">
        ...
        <article>
          ...
          <div className="space-y-6">
            ...
            <p className="text-[15px] leading-relaxed">
              No el punto más doloroso.<br />
              No el síntoma más evidente.<br />
            ...
            <p className="text-[15px] leading-relaxed">
              Las compensaciones empiezan a soltarse solas.<br />
              La respiración cambia.<br />
              La postura cambia.<br />
          ...
          <RelatedArticles slug="siempre-buscar-el-punto-de-origen" lang="es" />
        </article>
      </main>
    </div>
  );
